...
SECRET_KEY = '2t-axfxqx0#w*5@lz9x%63psw&r7m#188h2w-r!wfz3cg7rj=n'
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "rest_framework.authentication.SessionAuthentication",  # for login via admin
        "rest_framework_simplejwt.authentication.JWTAuthentication",  # for token auth
    ],
